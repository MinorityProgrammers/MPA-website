...
const MapJoin = () => (
  <section id="network" className="cta-five">
    <img
      src="https://www.minorityprogrammers.org/img/grace.jpg"
    ...
    />
    <img
      src="https://www.minorityprogrammers.org/img/myles.jpg"
      className="cta-five__members-3"
      alt=""
    />
    <img
      src="https://www.minorityprogrammers.org/img/michelle.jpg"
      className="cta-five__members-4"
      alt=""
    />
    <img
      src="https://www.minorityprogrammers.org/img/rosie.jpg"
      className="cta-five__members-5"
      alt=""
    />
    <img
      src="https://www.minorityprogrammers.org/img/kush.jpg"
    ...
    <div className="container text-center">
      ...
      <a
        ...
        target="_blank"
        className="thm-btn cta-five__btn"
        rel="noreferrer"
      >
        Join Today
      </a>
