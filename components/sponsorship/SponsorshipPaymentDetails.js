    ...
    <>
      <div className="step__details mt-2">
        <div className="container">
          ...
          <p>
            Your MINORITY {sponsorshipOption?.toUpperCase()} sponsorship payment
            of ${Number(amount).toFixed(2)} has been processed. An e-mail has
            been sent to {billingDetails?.payer?.email_address}. Please save
