...
const ProposalDetailsHeader = () => (
  <div>
    ...
    <div className="tw-flex tw-justify-between tw-border-gray-600 tw-border-t-2 tw-border-b-2">
      ...
      <div className="tw-flex ">
        <div className="tw-m-1 tw-p-2 tw-mt-4">
          <h1 className="tw-m-1 tw-text-center tw-text-black tw-text-xl">58</h1>
          <h1 className="tw-text-xl">Replies</h1>
        </div>
        <div className="tw-m-1 tw-p-2 tw-mt-4">
          <h1 className="tw-m-1 tw-text-center tw-text-black tw-text-xl">74</h1>
    ...
    <div className="tw-flex tw-justify-between">
      <div>
        ...
        posuere ut. Quisque quis lacinia tortor. Donec auctor consectetur nibh,
        eu varius mi porta nec. Quisque ultricies odio vitae nibh malesuada
        tristique vel sed leo. Donec egestas, urna eu auctor ultricies, massa
        lorem pellentesque quam, vitae congue urna quam ultricies ex.
      </div>
