...
const CreateProfileQuestions1 = ({ state, setState, step, setStep, inputStates, handleUsernameSubmit, closeProfileSetup, userData }) => {
    ...
    useEffect(() => {
        fetch("https://koinstreet-learn-api.herokuapp.com/api/v1/user").then(response =>
            response.json()
        ).then(data => {
