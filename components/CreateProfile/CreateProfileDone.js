...
const ProfileDone = ({ state, setState, step, setStep, closeProfileSetup }) => {
    ...
    return (
        <div className="cp-body">
            ...
            <div className="cp-top">
                <h1>Congratulations {Object.values(state)[0].userName}! </h1>
                ...
                <div className="cp__profile--container">
                    <div className="cp-formGrid1">
                        <div className="cp__profile--done">
                            <Avatar
                                style={{ width: '250px', height: '250px', background: state[5].avatarOptions.backgroundColor || "#fff", borderRadius: '100%' }}
                                {...state[5].avatarOptions}
                            />
                        </div>
                        <p>You are now able to review your own profile
                            as well as your MPA community. Cheers!</p>
