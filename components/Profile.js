  ...
  >
    <div className="tw-flex tw-justify-between">
      <div className="tw-m-4">
        <h2 className="tw-font-bold tw-text-primary-200 tw-text-xl">
          User Profile
        </h2>
    ...
    <div className="tw-bg-white tw-shadow-md  tw-rounded-md ">
      ...
      <div className="">
        <div className="tw-relative">
          <img
            ...
            className="tw-w-full tw-h-60 tw-rounded-t-md"
          />
          ...
          <div className="  tw-flex tw-flex-col-reverse tw-items-center tw-justify-center md:tw-grid tw-col-span-2  md:tw-grid-cols-3 ">
            <div className="tw-flex-col tw-flex tw-items-center tw-justify-center md:tw-justify-start  md:tw-items-start tw-my-2 tw-ml-3">
              <div className="tw-flex tw-my-3">
                ...
                <span className="tw-text-xs tw-text-primary-200 tw-ml-3">
                  Email
                </span>
              </div>
    ...
    <div className="tw-bg-white tw-rounded-md tw-shadow-md tw-mt-4 ">
      ...
      <div className="tw-m-4 tw-py-4">
        ...
        <p className="tw-text-sm tw-leading-6 tw-w-11/12">
          {user.bio || 'N/A'}
        </p>
      </div>
    </div>
