          ...
          <Swiper {...params}>
            <div className="item">
              <div
                ...
                style={{ backgroundImage: 'url(assets/images/blog-2-1.jpg)' }}
              >
            ...
            <div className="item">
              <div
                className="blog-two__single"
                style={{ backgroundImage: 'url(assets/images/blog-2-2.jpg)' }}
              >
                <div className="blog-two__inner">
                  <a href="news-details.html" className="blog-two__date">
                    <span>25</span>
            ...
            <div className="item">
              <div
                className="blog-two__single"
                style={{ backgroundImage: 'url(assets/images/blog-2-3.jpg)' }}
              >
                <div className="blog-two__inner">
                  <a href="news-details.html" className="blog-two__date">
                    <span>25</span>
