...
import MentorshipAppSideBarChat from './MentorshipAppSideBarChat';

const MentorshipAppSideBarNavigation = (props) => {
          ...
          <div className="tw-flex tw-flex-1 tw-flex-col">
            <nav className="tw-bg-white tw-text-2xl tw-font-medium tw-pb-4 tw-select-none">
              <ul className="tw-flex tw-cursor-pointer">
                <li
                  className="tw-flex tw-w-160px tw-px-4 tw-py-2"
