...
const MentorshipAppSideBarChat = function (props) {
  return (
    <div className="tw-w-1/2 tw-h-600px tw-bg-white tw-rounded-r-3xl tw-flex tw-flex-col tw-z-10 tw-relative">
      ...
      <div className="tw-flex-1 tw-bg-#F9F9F9 tw-px-4">
        ...
        {props.character.messages.map((msg, index) => <div className="tw-mt-4 tw-p-4 tw-bg-#EAEFF2 tw-w-max tw-max-w-280px tw-rounded-2xl">{msg.message}</div>)}
      </div>
