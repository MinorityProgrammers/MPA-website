      ...
      <div className="container-fluid">
        <div className="row no-gutters">
          <div className="col-lg-6 thm-base-bg">
            <div className="cta-two__single">
              <div className="cta-two__icon">
                <span><i className="kipso-icon-professor" /></span>
              </div>
              <div className="cta-two__content">
                ...
                <a href="https://discord.gg/zGBrEd7UCn" target="_blank" className="thm-btn cta-two__btn" rel="noreferrer">Sign Up</a>
              </div>
            </div>
          </div>
          <div className="col-lg-6 thm-base-bg-2">
            <div className="cta-two__single">
              <div className="cta-two__icon">
                <span><i className="kipso-icon-training" /></span>
              </div>
              <div className="cta-two__content">
