...
const FeaturedCourseList = ({course,  sameUserCourses,  handleCourseInfo,  enrolledBtn}) => {
        ...
        <div className="courses-items px-3 mb-4 mx-2">
            ...
            <div className="text-center pb-4">
                {userCoursesId.includes(_id) ?
                    <button disabled={enrolledBtn} onClick={() =>  handleCourseInfo(course)}className="btn px-5 banner-btn mt-3" data-toggle="modal" data-target="#exampleModal" >
                        Enrolled
                    </button>
                     :
                     !userCoursesId.includes(_id) ?
                         <button onClick={() =>  handleCourseInfo(course)} className="btn px-5 banner-btn mt-3" data-toggle="modal" data-target="#exampleModal" >
                            Enroll
                        </button>
                    : ""
                }
