...
const FeaturedCourses = ({courses,  handleCourseInfo, enrolledCourses,  enrolledBtn}) => {
            ...
            <div className="mb-5 pb-3">
                ...
                <div className={coursesLength > 2 ? "mt-3 courses-info pt-2 FRCourses" : "mt-3 courses-info pt-2 featured-courses"}>
                    <Slider {...conditionalInfinite}>
                        {courses && courses.map(course => <FeaturedCourseList course={course}  handleCourseInfo={ handleCourseInfo} key={course._id} sameUserCourses={sameUserCourses}  enrolledBtn={enrolledBtn}  />)}
                    </Slider>
                </div>
            </div>
        </div>
