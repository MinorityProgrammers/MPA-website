                    ...
                    <div className="activities-banner">
                        <div className="pt-5 mx-5 pe-5 ps-md-5 pb-5">
                            <div className="week-info mx-5 px-4">
                                ...
                                <p className="text-center mt-4 pt-2 mb-0">{completedModules}/{totalModules}</p>
                                <div className="progress mt-2 mb-2">
                                    <div className="progress-bar" style={{width: totalPercentage + "%"}}  role="progressbar" aria-valuenow={totalPercentage} aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
