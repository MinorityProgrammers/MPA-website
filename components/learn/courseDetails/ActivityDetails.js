...
import CourseSidebar from '../courseDetails/CourseSidebar';
...
const ActivityDetails = ({userInfo, enrolledCourses, modules, singleUserModuleInfo, userModules}) => {
    ...
    const {completionStatus, completionRate, completed, _id} = singleUserModuleInfo;
    ...
    let specificModules = modules.filter(module => module.level == moduleLevel);
                    ...
                    <div className="col-12 col-md-9 pl-0">
                        <div className="banner-bg">
                            <div className='player-wrapper'>
                                <ReactPlayer url={moduleInfo.url} width='100%' style={{height: '420px'}}    controls={true} 
                                onStart={onStart}
                                onEnded={handleWatch}
                                />
                                {watched && isOpen &&
