...
const RecommendedCourseList = function ({ course, handleCourseInfo, showModal }) {
  ...
  return (
    <div className="courses-items px-3 mb-4 mx-2 tw-bg-white tw-shadow-lg ">
      ...
      <div className="text-center pb-4">
        <button onClick={() => {showModal(); handleCourseInfo(course)}} data-toggle="modal" data-target="#exampleModal" className="btn px-5 banner-btn mt-3">
          Enroll
        </button>
      </div>
