    ...
    if (typeof window.ethereum !== 'undefined') {
      ...
      try {
        ...
        if (err.code === 4001) {
          ...
          alert(`${err.data.message === 'execution reverted' ? 'check that you have not recieved $MPA token before' : 'check that your wallet contains some $Minority token'}`);
        }
        setErrorState('');
      }
    } else {
        ...
        <div className="form-container">
          ...
          <span className="icon-bg">
            <span className="tooltiptext">
              ...
              $MINORITY token in your wallet, each wallet is only eligible for one request.
            </span>
