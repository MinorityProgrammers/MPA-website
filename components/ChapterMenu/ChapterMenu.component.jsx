      ...
      <div className={styles.menuContainer}>
        ...
        <section className={styles.item2}>
          <div className={styles.iconAndTextContainer}>
            <img className={styles.icon} src="/assets/images/check-circle-outline.svg" alt="globe" style={{ fill: 'black' }} />
        ...
        <section className={styles.item3}>
          <div className={styles.iconAndTextContainer}>
            <img className={styles.icon} src="/assets/images/check-circle-outline.svg" alt="globe" style={{ fill: 'red' }} />
        ...
        <section className={styles.item4}>
          <div className={styles.iconAndTextContainer}>
            <img className={styles.icon} src="/assets/images/check-circle-outline.svg" alt="globe" />
