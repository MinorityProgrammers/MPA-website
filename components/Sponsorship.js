...
const Sponsorship = ({ displayCheckout, handleMCardClick }) => (
    ...
    <div className="sponsor-page">
      <div className="sp-top">
        <div className="sp-head-text">
          ...
          <p>
            Team up with the largest international diversity focused development
            organization.
          </p>
          <p>
      ...
      <div className="sp-middle">
        ...
        <div className="sp-cards">
          <div className="m-cards-wrapper">
            ...
            <div className="m-card" onClick={() => handleMCardClick('friend')}>
              <div className="c-header">
                <div className="sp-icon mi-icon bg-white">
                  <img
