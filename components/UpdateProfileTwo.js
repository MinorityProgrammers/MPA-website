...
const UpdateProfileTwo = ({ open = true, setOpen = () => { }, userData }) => {
    ...
    const [newNationality, setNewNationality] = useState(userData.Nationality || '');
                                            ...
                                            <div className="up-input">
                                                {
                                                    (field.type == "list") ?
                                                        ...
                                                        <input id={field.name} name={field.name} placeholder={field.label} type={field.type} value={field.value || ""} readOnly={!field.edit} onChange={(e) => {
                                                            field.setValue(e.target.value);
                                                        }} />
                                                }
                                            </div>
                            ...
                            <div className="up-modal-section-body">
                                {
                                    socialMedia.map((field, id) => (
                                        <div className="up-social" key={id}>
                                            <label htmlFor={field.name}>{field.label}</label>
                                            <div className="up-input">
                                                <input id={field.name} name={field.name} placeholder={field.label} type={field.type} value={field.value || ""} onChange={(e) => {
                                                    field.setValue(e.target.value);
                                                }} />
                                            </div>
                                        </div>
