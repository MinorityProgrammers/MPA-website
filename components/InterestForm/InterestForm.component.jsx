...
const InterestForm = ({ token }) => {
  ...
  const getButtonStatus = button => {
    ...
    } else if (sectionsToArray.indexOf(activeButton) < sectionsToArray.indexOf(button)) {
        ...
        {submitError &&
          (<div className={styles.submitFeedbackWrapper}>
            <div className={styles.submitFeedback}>
              <div className={styles.submitErrorTitle}><i style={{ color: '#f356c7' }} className="fas fa-exclamation-circle"></i> There was an issue creating your page!</div>
              ...
              <form onSubmit={(handleSubmit)} className={styles.form}>
                ...
                <div className={styles.buttonWrapper}>
                  <div className={styles.buttonContainer}>
                    <div style={{ display: sections.section_1 ? 'none' : 'block' }} className={`${styles.button} ${styles.prev}`} onClick={handlePrev}><i className="fas fa-angle-left"></i> Back </div>
                    <div style={{ display: sections.section_7 ? 'none' : 'block' }} className={`${styles.button} ${styles.next}`} onClick={handleNext}>Next <i className="fas fa-angle-right"></i></div>
