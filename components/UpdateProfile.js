    ...
    >
      <div className="tw-flex tw-justify-between">
        <div className="tw-text-gray-100">
          <h2 className="tw-font-bold tw-text-primary-200 tw-text-xl md:tw-text-2xl">
            {' '}
            Profile
          </h2>
      ...
      >
        ...
        <form className="tw-w-full  tw-pb-4" onSubmit={handleSubmit}>
          <div className="tw-grid  tw-grid-cols-1 md:tw-grid-cols-2 tw-w-full tw-justify-items-center">
            <DashboardInputs
              holder={user.firstName || null}
              name="firstName"
              new={newFirstName}
              setNew={setNewFirstName}
            />
            <DashboardInputs
              holder={user.lastName || null}
              name="lastName"
              new={newlastName}
              setNew={setNewLastName}
            />
          </div>
          <div className="tw-grid  tw-grid-cols-1 md:tw-grid-cols-2 tw-w-full tw-justify-items-center">
            <DashboardInputs
              holder={user.email || 'Your email'}
              name="email"
              new={newEmail}
              setNew={setNewEmail}
            />
            <DashboardInputs
              holder={user.phoneNumber || 'phoneNumber'}
              name="phoneNumber"
              new={newPhoneNumber}
              setNew={setNewPhoneNumber}
            />
          </div>
          <div className="tw-grid  tw-grid-cols-1 md:tw-grid-cols-2 tw-w-full tw-justify-items-center">
            <DashboardInputs
              ...
              name="location"
              new={newLocation}
              setNew={setNewLocation}
            />
            <DashboardInputs
              holder="Birth Date (MM/DD/YY)"
              name="birthDay"
              new={newBirthDate}
