  ...
  const dummyProjectData = [
    ...
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      thumbnail:
        'https://s3-alpha-sig.figma.com/img/95eb/9b0c/a4581433c385cef18426f59f409d4c42?Expires=1639353600&Signature=WVRXJhwJf8kXF3mj175FXXCoP5uk34jvKvcNfb-QT45lR--AKyHoz8SMj2Z-coi7Z0ZY6JYor3gFh3yVdPxudv-4ABwOHpQaNawol2ZWkFbtAyyAvzqI7oCRUK19DgnddOZchW8PECc8vnJg-Dm~e0nZ~dBwYSZd6RkKrdBBdyI66YRojG7A6hwAU4IkUofDTcxotSX56UG8-r5q0FAIV4GBywFW2eyZt24cKGD7t7SaeFq6vTm2sXOT2zjbgIbo1kXHCN98BAITS7mgGIBklo79xZZG7dUJLvfGu0r81u2CmcwQBi2F~03MbG1ZuN9dcd3BU~1bAyfwpCOWVbvPXg__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA',
    },
    {
      projectId: 2,
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ maxWidth: '70%', overflowY: 'hidden' }}
        >
          <div
