...
const TasksList = () => (
  <div className="overview-courses-cards d-flex flex-column" style={{ width: '100%', height: '100%' }}>
    <TaskCard />
    <TaskCard />
    <TaskCard />
    <TaskCard />
  ...
  <div className="overview-course-card d-flex flex-row justify-content-between">
    ...
    <div className="d-flex flex-row" style={{ width: '70%' }}>
      ...
      <div className="overview-course-card-info d-flex flex-column justify-content-center" style={{ width: '78%', marginLeft: '2%', height: '100%' }}>
        ...
        <p className="overview-course-card-description">Cool idea, host an event</p>
      </div>
    </div>
    ...
    <div className="d-flex flex-row justify-content-between" style={{ width: '30%' }}>
      ...
      <div className="overview-course-currency d-flex justify-content-center flex-column align-items-center" style={{ marginRight: '2%' }}>
        {/* INSERT DATA: replace number 15 with `${data.variable}` */}
