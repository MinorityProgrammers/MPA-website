...
const OverviewEvents = (props) => {
  ...
  return (
    loading
      ? (
        <div className="d-flex flex-column justify-content-start h-100" style={{ overflowY: 'scroll' }}>
          <p style={{ fontSize: '18px', fontWeight: '700', color: 'black' }}>Events </p>
          <div className="d-flex flex-row justify-content-start align-items-center" style={{ lineHeight: 2, overflowX: 'hidden' }}>
            <Skeleton count={7} height={20} width={1200} />
          </div>
          <p style={{ fontSize: '18px', fontWeight: '700', color: 'black' }}>Upcoming </p>
          <div className="d-flex flex-column justify-content-start align-items-center" style={{ lineHeight: 2, overflowX: 'hidden' }}>
