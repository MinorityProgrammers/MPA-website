        ...
        <div className="col-lg-6">
          <div className="countdown-one__content">
            ...
            <p className="countdown-one__tag-line">
              Join the network, learn relevant IT skills, and get work!
            </p>
            <p className="countdown-one__text">
              Regardless of age, or background, our international network has a
              place for you!
            </p>
          </div>
        </div>
        <div className="col-lg-6">
          <div className="become-teacher__form">
            <div className="become-teacher__form-top">
              <h2 className="become-teacher__form-title">Join MPA</h2>
            </div>
            <form
              action="#"
              method="POST"
