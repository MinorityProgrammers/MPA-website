        ...
        <div className="container-fluid clearfix">
          <div className="cta-six__left">
            <div className="cta-six__content">
              <img
                src="assets/images/diversity-stem.jpg"
                width="580px"
                height="314px"
                alt=""
              />
          ...
          <div className="cta-six__right">
            <img
              src="/assets/images/diversity-stem-2.jpg"
              width="580px"
              height="500px"
              alt=""
            />
    ...
    >
      <div className="container">
        <h2 className="diversity-statement__text">
          Here at Minority Programmers, diversity is our primary focus. It does
          not matter what race and ethncitiy you belong to. We believe eveyrone
          should have an equal opportunity in learning STEM. When you enroll,
          Minority Programmer will fit you right in amongst our diversed
        ...
        <div className="container-fluid clearfix">
          ...
          <div className="cta-six__right">
            <h2 className="global-statement__text">
              We have a global network of STEM learning consisting of different
              countries throughout the world. Countries such as Nigeria, China,
              and Ukraine. Be the first to join from your country today.
            </h2>
          </div>
        </div>
      </section>
      <div className="container text-center">
        ...
        <a href="/auth" className="thm-btn cta-five__btn">
          Join Today
        </a>
      </div>
    </section>
