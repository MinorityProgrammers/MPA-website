...
const PrincipleSoftware = () => {
                    ...
                    <div className="container-fluid clearfix">
                        <div className="cta-six__left">
                            <div className="cta-six__content">
                                <img src="assets/images/software-engineer-1.jpg" width="580px" height="380px" alt="" />
                            </div>
                        </div>
                        <div className="cta-six__right">
                            <img src="/assets/images/software-engineer-2.jpg" width="580px" height="500px" alt="" />
                        </div>
                    </div>
            </section>
            </div>        
    ...
    Minority Programmers specializes in emerging technologies. Our Software Engineers curriculum is full of courseware and experienced instructors who will mentor you throughout your journey. 
               ...
               <section id="training" className="cta-six thm-gray-bg">
                    <div className="container-fluid clearfix">
                        <div className="cta-six__left">
                            <div className="cta-six__content">
                                <img src="assets/images/software-engineer-3.jpg" width="580px" height="400px" alt="globe" />
                            </div>
                        </div>
                        <div className="cta-six__right">
            ...
            <div class="container text-center"><h2 class="cta-five__title">Join the International Network Today</h2><p class="cta-five__text">Only network where you feel like family and get the opportunity to support yours through STEM</p><a href="/auth" class="thm-btn banner-two__btn">Join Today</a></div>
    </section>
    </section>
