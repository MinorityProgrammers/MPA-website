                ...
                <div className="container">
                    ...
                    <div className="row justify-content-md-center card__wrapper">
                        <div className="col-lg-3 text-center intern__type--card">
                            ...
                            {data ? <Link href="/careers_explainer">
                                <button className="btn btn-orange"> <span>Apply</span><i className="fas fa-angle-right"></i></button>
                            </Link> :
                                <button onClick={() => { setClickRegister(true) }} className="btn btn-orange tw-cursor-pointer"> <span>Apply</span><i className="fas fa-angle-right"></i></button>
                            }
                        ...
                        <div className="col-lg-3 text-center intern__type--card">
                            ...
                            <h1>Supervisor</h1>
                            <p>Gain working experience on STEM field</p>
                            {data ? <Link href="/volunteer">
                                <button className="btn btn-orange"> <span>Build</span> <i className="fas fa-angle-right"></i></button>
                            </Link> :
                                <button onClick={() => { setClickRegister(true) }} className="btn btn-orange tw-cursor-pointer"> <span>Build</span> <i className="fas fa-angle-right"></i></button>
                            }
                        ...
                        <div className="col-lg-3 text-center intern__type--card">
                            ...
                            <p>Gain working experience on STEM field</p>
                            {data ? <Link href="/partner">
                                <button className="btn btn-orange"> <span>Hire</span> <i className="fas fa-angle-right"></i></button>
                            </Link> :
                                <button onClick={() => { setClickRegister(true) }} className="btn btn-orange tw-cursor-pointer"> <span>Hire</span> <i className="fas fa-angle-right"></i></button>
                            }
                ...
                <div className="intern__cards">
                    <div className="intern__speciality--cards">
                        <div className="intern__speciality--card">
                            ...
                            <div onClick={() => openModal("1", "2")} className="img-banner-app">
                                <img src="/assets/images/Internship/computer.png" alt="" className="card-img-top rounded-0" />
                            </div>
                            <InternshipModal
                                myData={myData}
                        ...
                        <div className="intern__speciality--card">
                            <h1 >UI/UX  Design</h1>
                            <div onClick={() => openModal("2", "6")} className="img-banner-app">
                                <img src="/assets/images/Internship/ui-ux.png" alt="" className="card-img-top rounded-0" />
                            </div>
                            <InternshipModal
                                myData={myData}
                                closeModal={closeModal}
                        ...
                        <div className="intern__speciality--card">
                            ...
                            <div onClick={() => openModal("3", "14")} className="img-banner-app">
                                <img src="/assets/images/Internship/marketing.png" alt="" className="card-img-top rounded-0" />
                            </div>
                            <InternshipModal
                                myData={myData}
                                closeModal={closeModal}
                        ...
                        <div className="intern__speciality--card">
                            ...
                            <div onClick={() => openModal("4", "18")} className="img-banner-app">
                                <img src="/assets/images/Internship/blokchain.png" alt="" className="card-img-top rounded-0" />
                            </div>
                            <InternshipModal
                                myData={myData}
                                closeModal={closeModal}
                    ...
                    <div className="intern__more">
                        <div className="download__app">
                            ...
                            <Link href="/learn-page" target="_blank">
                                <button className="btn-download">Learning dApp</button>
                            </Link>
                        </div>
                        <div className="about__internship">
                            <p>Minority Programers Internship Experience </p>
                            <div className="img-banner-app">
                                <img src="/assets/images/Internship/videoback.png" className="heading__img card-img-top rounded-0" />
                        ...
                        <div className="mentorship__card">
                            ...
                            <Link href="/mentorship" target="_blank">
                                <button className="btn-download">Mentorship Program</button>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="intern__cards built__cards">
                    ...
                    <div className="intern__more">
                        <div className="event">
                            ...
                            <h1>The History of Defi Summer-
                                Yudhisitra Fitriansyah
                            </h1>
                            <p>“DeFiSummer” came to life during the summer of 2020 after the crypto space saw a huge advantage with liquidity mining and how it brought monetary value and some governance control. The hype created major buzz and everyone was getting into it.
                            </p>
                        </div>
                    </div>
                </div>
