  ...
  <section>
    <div className="internship__intro pl-5 pr-5">
      <div className="internship__info p-2">
        ...
        <p>
          Interns are assigned to complete a 3-month roadmap and SMART goal for
          their internship after which the hiring team evaluates to best place
          the intern in teams and project tasks that give the most exposure to
          what that intern wants to learn. After this tailored experience,
