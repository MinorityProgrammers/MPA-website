    ...
    <div className="job-skill tw-flex tw-mb-3" key={props.id}>
      ...
      <div className="tw-w-full tw-grid tw-grid-cols-2 tw-gap-x-4 tw-mr-2">
        <div className="tw-w-full tw-flex tw-flex-col tw-justify-center tw-mr-2">
          ...
          <select
            name={`job_skill-${props.skill_order}`}
            required
          ...
          >
            <option value="html" style={{ background: "#151371" }}>
              HTML
            </option>
            <option value="css" style={{ background: "#151371" }}>
              CSS
            </option>
            <option value="javascript" style={{ background: "#151371" }}>
              Javascript
            </option>
            <option value="react" style={{ background: "#151371" }}>
              React
            </option>
            <option value="redux" style={{ background: "#151371" }}>
              Redux
            </option>
          </select>
        </div>
        <div className="tw-w-full tw-flex tw-flex-col tw-justify-center">
          ...
          <input
            name={`job_years-${props.skill_order}`}
            required
      ...
      <button
        ...
        onClick={() => props.removeSkill(props.removerInd)}
      >
        X
      </button>
    </div>
