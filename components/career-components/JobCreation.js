...
const SkillsDiv = function (props) {
  return (
...
const JobCreation = function () {
  ...
  const jobSkills = skillsArray.map((item, index, array) => <SkillsDiv removeSkill={removeSkill} key={item.id} removerInd={index} skill_order={index + 1} />);
    ...
    <div className="tw-relative">
      ...
      <form className="job-create-form tw-w-11/12 sm:tw-w-3/4 md:tw-w-3/5 lg:tw-w-1/2 xl:tw-w-5/12 tw-mx-auto tw-bg-black tw-bg-white tw-bg-opacity-25 tw-p-10 tw-rounded-3xl tw-relative tw-z-10">
        ...
        <div className="form-input-group tw-flex tw-flex-col tw-mb-3">
          ...
          <div className="tw-flex tw-justify-start tw-flex-wrap">
            <label className="jobType-label tw-text-white tw-mr-5 tw-mb-0">
              <input name="remote" required type="radio" value className="jobType-checkbox tw-mr-1" />
              <span className="jobType-custom-checkbox" />
              Yes
            </label>
            <label className="jobType-label tw-text-white tw-mr-5 tw-mb-0">
              <input name="remote" type="radio" value={false} className="jobType-checkbox tw-mr-1" />
              <span className="jobType-custom-checkbox" />
              No
            </label>
          </div>
        ...
        <div className="form-input-group tw-flex tw-flex-col tw-mb-3">
          ...
          <div className="tw-flex tw-justify-start tw-flex-wrap">
            <label className="jobType-label tw-text-white tw-mr-5 tw-mb-0">
              <input name="pay_interval" required type="radio" value="annually" className="jobType-checkbox tw-mr-1" />
              <span className="jobType-custom-checkbox" />
              Annually
            </label>
            <label className="jobType-label tw-text-white tw-mr-5 tw-mb-0">
              <input name="pay_interval" type="radio" value="hourly" className="jobType-checkbox tw-mr-1" />
              <span className="jobType-custom-checkbox" />
              Hourly
            </label>
          </div>
        ...
        <div className="tw-flex tw-flex-col tw-mb-3">
          ...
          <textarea name="additional_compensation" rows="6" className="tw-text-white focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-yellow-300 tw-py-1 tw-px-2 tw-border tw-border-white tw-bg-transparent tw-placeholder-white tw-placeholder-opacity-80" placeholder="List any additional compensation offered" />
        </div>

        <div className="tw-flex tw-flex-col tw-mb-3">
          <label className="tw-text-white tw-text-lg tw-mb-1 tw-font-bold">Benefits</label>
          <textarea rows="6" className="tw-text-white focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-yellow-300 tw-py-1 tw-px-2 tw-border tw-border-white tw-bg-transparent tw-placeholder-white tw-placeholder-opacity-80" placeholder="Add benefits, separated by commas" />
        </div>
