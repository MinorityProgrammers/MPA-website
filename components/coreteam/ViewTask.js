...
import TaskNotificationHeader from '../ProjectManager/TaskNotificationHeader';
    ...
    <section className="page-gradient tw-w-100">
      {/* <div className="p-notification-banner tw-flex ">
                <div className="ch-pro notify tw-self-center tw-w-1/2">
                    <img src="/assets/images/coreteamimg/star.png" className="" alt="star" />
                    <h2 className="text-center ">View Tasks</h2>
                    <p className="text-center">View, organize and access your tasks here.</p>
                </div>
                <div className=" notify-img tw-w-1/2 tw-self-center">
                    <img className="tw-h-48" src="/assets/images/coreteamimg/taskbannar.png" alt="bg" />
                </div>
            </div> */}
      {/* change------ */}
