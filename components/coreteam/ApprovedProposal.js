...
const ApprovedProposal = function () {
          ...
          ? (
            <div className=" tw-rounded-lg approved">
              <div className="tw-p-4 tw-text-white tw-m-4">
                ...
                <p><small>The following proposals you voted got approved.</small></p>
              </div>
                ...
                <div className="pl-5 pr-5">
                  <div className=" tw-flex tw-justify-between ">
                    ...
                    <div className="tw-flex tw-items-center">
                      <BiCheckCircle className="approved-icon tw-rounded-full tw-text-white " size="20px" />
                      <p className="tw-ml-2 tw-text-purple-600 tw-text-lg"><strong>Approved</strong></p>
                    </div>
                  </div>
                  <hr />
                  ...
                  <div className="s-p-description tw-flex tw-justify-between tw-items-center">
                    ...
                    <div className="s-p-view tw-w-1/5 tw-text-center">
                      <p>
                        <button type="button" className="green-btn tw-p-2 tw-rounded tw-text-white">View Proposal</button>
                      </p>
