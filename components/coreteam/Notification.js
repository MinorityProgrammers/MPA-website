      ...
      <section className="  tw-w-100 tw-mt-20 ">
        <div className="banner  tw-flex tw-items-center  ">
          <div className="banner-left  tw-self-center tw-w-1/2">
            ...
            <h4 className="text-center tw-text-white">
              <small>You have 13 new notifications.</small>
            </h4>
          </div>
          <div className=" tw-w-1/2  tw-ml-64">
            <img
              className="tw-h-48"
              src="/assets/images/coreteamimg/notifi.png"
              alt="bg"
            />
          </div>
        </div>
        ...
        <div className="tw-container tw-mx-auto voted tw-rounded-lg">
          <div className=" tw-rounded-lg voted">
            <div className="tw-p-4 tw-text-white tw-m-4">
              <h1 className="tw-uppercase tw-text-2xl">
                Proposals to be voted / revoted.
              </h1>
              <p>
                <small>Please Approve or disapprove proposals</small>
              </p>
            </div>
            ...
            <div>
              {currentActions.map((info) => (
                <div
                  className={`tw-p-4 tw-m-8   tw-bg-white tw-text-dark tw-border-t-8  tw-border-${info.borderColor}-500`}
                >
                  <div className="">
                    <div className=" tw-flex tw-justify-between ">
                      <div className="">
                        <h1 className="parsonal-title ">
                          {info.title ? info.title : 'comming proposal test'}
                        </h1>
                        <p>
                          {' '}
                          <small>
                    ...
                    <div className="tw-flex tw-justify-between tw-items-center tw-my-3">
                      <div className="tw-flex">
                        <img
                          ...
                          className="tw-mr-2"
                          src={
                            info.userId.profilePicture
                              ? info.userId.profilePicture
                              : '/assets/images/coreteamimg/user.png'
                          }
                          alt="user"
                        />
                      ...
                      <div className="tw-flex">
                        ...
                        <h3 className="tw-border-2  tw-border-black tw-ml-3 text-center tw-p-2 tw-text-green-900">
                          Disapprove
                        </h3>
                      </div>
                    </div>
                      ...
                      <div className="s-p-view tw-w-1/5 tw-text-center ">
                        <p>
                          <Link href={`/proposal-info/${info._id}`}>
                            <a className="grdient-btn tw-rounded tw-p-2 tw-text-white">
                              View Proposal
                            </a>
                          </Link>
                        </p>
            ...
            >
              <div className="pl-5 pr-5">
                <div className=" tw-flex tw-justify-between ">
                  ...
                  <div className="tw-flex tw-items-center">
                    <ImCross
                      style={{ background: '#FF03B5' }}
                      className="text-white p-1 rounded"
                    />
                    <h3 className="tw-ml-2">
            ...
            <div className="tw-mx-8 tw-flex    gap-10  ">
              <div className="task-card tw-w-1/2 tw-my-6 tw-rounded-bl-lg tw-rounded-br-3xl tw-mr-6">
                <div className="task-des tw-flex ">
                  ...
                  <h1 className="tw-mr-3 tw-text-md tw-text-indigo-900 tw-font-semibold">
