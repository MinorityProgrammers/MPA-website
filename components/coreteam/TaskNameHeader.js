      ...
      <div className="tw-flex w-items-center tw-px-5 ">
        <div className="tw-container tw-flex  tw-items-center ">
          ...
          <img
            ...
            alt="user"
            className="tw-h-6 tw-w-6 tw-ml-3"
          />
      ...
      <div className="tw-flex tw-items-center tw-mt-4 tw-justify-between sm:tw-flex-col tw-px-0 tw-px-3">
        <div className="tw-flex tw-items-center tw-gap-x-5 tw-mb-4 sm:tw-w-auto">
          ...
          {editTagCart.map((addtag) => (
            <div
              onClick={() => HandleRemoveEditTag(addtag.id)}
              className="feature tw-mt-3 tw-cursor-pointer"
            >
              {addtag.tagName}
            </div>
          ))}
          <div className="editTag">
            <div
              ...
              data-tip=" edit tags"
              className="tw-bg-indigo-400 tw-rounded-full tw-h-8 tw-flex tw-w-8 tw-items-center tw-justify-center tw-btn tw-cursor-pointer"
            >
              <ReactTooltip />
              <svg
                width="17"
              ...
              <div id="myDropdown" className="dropdown-content">
                {allEditTags.map((tag) => (
                  <a className="hover:tw-bg-gray-200 " key={tag.id}>
                    <h3
                      onClick={() => handleEditTagsCat(tag)}
                      className="tw-gap-x-3 tw-cursor-pointer tw-capitalize"
                    >
                      {tag.tagName}
                    </h3>
                  </a>
          ...
          <div
            className="tw-bg-indigo-400 tw-rounded-full tw-h-8 tw-flex tw-w-8 tw-items-center tw-justify-center "
            onClick={openModal}
          >
            <svg
              width="17"
          ...
          <div>
            <div
              onClick={() => setPiority(!piority)}
              id="check"
              className="tw-bg-indigo-400 tw-rounded-full tw-h-8 tw-flex tw-w-8 tw-items-center tw-justify-center  tw-btn tw-cursor-pointer"
              data-tip="set piority"
            >
              <ReactTooltip />
              <svg
                width="14"
            ...
            {piority && (
              <div id="myDropdown" className="dropdown-content">
                {allPiorityFlag.map((flag) => (
                  <a
                    className="hover:tw-bg-gray-200 "
                    key={flag.id}
                    onClick={() => handlePiorityflagCart(flag)}
                  >
                    <div className="tw-flex tw-gap-x-4 tw-cursor-pointer tw-items-center">
                      <span className="tw-text-pink-500">
                        <RiFlag2Fill className="tw-h-5 tw-w-5  " />
                      </span>
        ...
        <div className="tw-flex tw-items-center tw-gap-x-5 sm:tw-w-auto sm:tw-gap-x-2">
          ...
          <div>
            <p>
              <span className="sm:tw-text-sm ">TIME TRACKED</span>
            </p>
          ...
          >
            <path
              d="M29.2045 13.3569C28.9791 13.029 23.5625 5.34766 14.9999 5.34766C7.65251 5.34766 1.10535 12.9848 0.829863 13.3104C0.64265 13.5322 0.64265 13.8578 0.829863 14.0808C1.10535 14.4064 7.65251 22.0436 14.9999 22.0436C22.3473 22.0436 28.8944 14.4064 29.1699 14.0808C29.3429 13.8757 29.3583 13.5787 29.2045 13.3569ZM14.9999 20.851C9.10986 20.851 3.50955 15.234 2.08686 13.6956C3.5072 12.1561 9.10153 6.54026 14.9999 6.54026C21.8917 6.54026 26.7562 12.1489 27.944 13.6634C26.5725 15.1529 20.94 20.851 14.9999 20.851Z"
              fill="#726EA8"
            />
            <path
              d="M15.0007 8.92578C12.3699 8.92578 10.2305 11.0652 10.2305 13.696C10.2305 16.3268 12.3699 18.4662 15.0007 18.4662C17.6315 18.4662 19.7709 16.3268 19.7709 13.696C19.7709 11.0652 17.6315 8.92578 15.0007 8.92578ZM15.0007 17.2738C13.0282 17.2738 11.423 15.6685 11.423 13.6961C11.423 11.7236 13.0282 10.1184 15.0007 10.1184C16.9732 10.1184 18.5784 11.7236 18.5784 13.6961C18.5784 15.6685 16.9732 17.2738 15.0007 17.2738Z"
              fill="#726EA8"
            />
            <path
              d="M25.6784 0C21.9958 0 19 2.99576 19 6.67836C19 10.361 21.9958 13.3567 25.6784 13.3567C29.361 13.3567 32.3567 10.361 32.3567 6.67836C32.3567 2.99576 29.361 0 25.6784 0Z"
              fill="#726EA8"
            />
            <path
              d="M23.304 9V8.232L25.512 6.256C25.7627 6.02667 25.9413 5.82667 26.048 5.656C26.1547 5.48 26.208 5.29867 26.208 5.112C26.208 4.86667 26.112 4.664 25.92 4.504C25.728 4.344 25.488 4.264 25.2 4.264C24.9333 4.264 24.6827 4.31733 24.448 4.424C24.2187 4.53067 23.968 4.70667 23.696 4.952L23.08 4.216C23.4053 3.92267 23.7493 3.70133 24.112 3.552C24.4747 3.40267 24.848 3.328 25.232 3.328C25.5307 3.328 25.8053 3.37067 26.056 3.456C26.312 3.536 26.528 3.65067 26.704 3.8C26.8853 3.94933 27.024 4.13067 27.12 4.344C27.2213 4.55733 27.272 4.78933 27.272 5.04C27.272 5.36 27.192 5.656 27.032 5.928C26.872 6.2 26.5947 6.512 26.2 6.864L24.832 8.08H27.344V9H23.304Z"
              fill="white"
            />
          </svg>
        </div>
