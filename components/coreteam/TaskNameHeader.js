...
import userinfo from '../../components/coreteam/User.json';
import editTagsData from '../../components/coreteam/editTagsData.json';
import piorityflagData from '../../components/coreteam/piorityflagData.json'
        ...
        <div className=" tw-bg-white   tw-container tw-mx-auto tw-py-5 tw-mt-20">
            <div className="tw-flex w-items-center tw-px-5 ">
                <div className="tw-container tw-flex  tw-items-center ">
                    <p>In</p>
                    <p>Category</p><RiArrowRightSLine /> <p>Sub Category</p> <p className="tw-ml-2">For</p>
                    ...
                    <div >  <RiUserAddLine onClick={() => setNewUser(!newUser)} className="tw-cursor-pointer" />
                        {
                            newUser && <div id="myDropdown" class="dropdown-content">
                                {
            ...
            <div className="tw-flex tw-items-center tw-mt-4 tw-justify-between sm:tw-flex-col tw-px-0 tw-px-3">
                <div className="tw-flex tw-items-center tw-gap-x-5 tw-mb-4 sm:tw-w-auto">
                    ...
                    <div className="editTag" >
                        ...
                        {
                            editTags && <div id="myDropdown" className="dropdown-content">
                                {
                                    allEditTags.map(tag => <a className="hover:tw-bg-gray-200 " key={tag.id} >
                    ...
                    <div className="tw-bg-indigo-400 tw-rounded-full tw-h-8 tw-flex tw-w-8 tw-items-center tw-justify-center " onClick={openModal}>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="1.05273" y="0.720703" width="11.271" height="2.58918" stroke="white" stroke-width="0.75" />
                            <rect x="2.68164" y="6.35742" width="12.021" height="3.33918" fill="white" />
                            <rect x="5.06055" y="12.7422" width="11.271" height="2.58918" stroke="white" stroke-width="0.75" />
                        </svg>
                    ...
                    {
                        piorityFlagCart.map(flag => <div onClick={() => HandleRemoveFlag(flag.id)} className="tw-bg-indigo-400 tw-rounded-full tw-h-8 tw-flex tw-w-8 tw-items-center tw-justify-center  tw-btn tw-cursor-pointer" data-tip={flag.flagName}>
                            <ReactTooltip />
                    ...
                    <div>
                        ...
                        {
                            piority && <div id="myDropdown" className="dropdown-content">
                                {
                                    allPiorityFlag.map(flag => <a className="hover:tw-bg-gray-200 " key={flag.id} onClick={() => handlePiorityflagCart(flag)}>
                ...
                <div className="tw-flex tw-items-center tw-gap-x-5 sm:tw-w-auto sm:tw-gap-x-2">
                    <div>
                        ...
                        <p> <span className="sm:tw-text-sm ">Jun 11th, 3:00 pm</span></p>
                    </div>
                    <div>
                        ...
                        <h3 className="tw-flex tw-items-center tw-gap-x-2">
                            ...
                            <span className="sm:tw-text-sm">0:00:00</span></h3>
                    </div>
                    <div>
                        ...
                        <h3 className="tw-flex tw-items-center tw-gap-x-2">
                            ...
                            <span className="sm:tw-text-sm ">15 h</span></h3>
                    </div>
                    <div>
                        <h3 className="sm:tw-text-sm ">START DATE</h3>
                        <h3 className="sm:tw-text-sm "> <span>Jun 12</span></h3>
                    </div>
                    <div>
                        <h3 className="sm:tw-text-sm ">DUE DATE</h3>
                        <h3> <span className=" tw-text-pink-500 sm:tw-text-sm">Jun 15</span></h3>
                    </div>
