        ...
        <Swiper {...params} getSwiper={setSwiper}>
          <div className="heading__container">
            <div className="homepage__about-left">
              ...
              <p className="lead text_white">
                We are an international network of developers unifying
                together to build socially impactful projects &amp; spread
                STEM education to marginalized communities.
                </p>
            </div>
          ...
          <div className="heading__container">
            <div className="homepage__about-left">
              ...
              <p className="lead text_white">
                ...
                guidance, and learn relevant IT skills to become a world
                leader in tech.
                </p>
            </div>
            <div className="homepage__about-right resize">
              <img
                src="/assets/images/about2.2.svg"
                className="heading__img"
              />
              <img
                src="/assets/images/about2.1.svg"
                className="heading__img"
              />
              <button name="play" onClick={() => setOpen(true)} />
            </div>
          ...
          <div className="heading__container">
            <div className="homepage__about-left">
              ...
              <p className="lead text_white">
                Complete turnkey decentralized vertical integration for
                scaling minority startups from ideation to large scale
                businesses using decentralized protocols.
                </p>
            </div>
            <div className="homepage__about-right">
          ...
          <div className="heading__container">
            <div className="homepage__about-left">
              ...
              <p className="lead text_white">
                ...
                onboard diverse talent that cares about advancing the
