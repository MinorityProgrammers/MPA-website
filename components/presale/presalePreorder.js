...
const PresalePreorder = () => (
  <>
      ...
      <div className="buttons">
        <div className="top-buttons">
          ...
          <div className="button2">
            <span style={{ fontSize: '2rem' }}> 0 $MINORITY RESERVED</span>
            <svg
              width="30"
              height="53"
              viewBox="0 0 40 53"
    ...
    <div className="tokenamics-chart">
      <img src="/assets/images/presale/token-chart.png" alt="token_chart" />
    </div>
    <div className="token">
    ...
    <>
      ...
      <div className="testimonials">
        ...
        <div className="testimonial2">
          <div className="inner-container">
            <div className="inner-text">
              I can learn, start a community, gain mentorship, attend events,
              get work & get rewarded for it?
              <br />
              <div className="user-name">
        ...
        <div className="testimonial1">
          <div className="inner-container">
            ...
            <div className="inner-text">
              ...
              <br />
              <div className="user-name">
                First black MAN on the moon there has never been one actually.
              </div>
            </div>
          </div>
        </div>
