                ...
                <div className="companyDetails-wrapper tw-mt-10">
                    ...
                    <div className="companyDetails-container">
                        ...
                        <div className="companyDetails-container-info">
                            ...
                            <div className="companyDetails-container-info-relationship"><strong>{company.relation_type}</strong> of Minority Programmers Association since <strong>{new Date(company.mpa_relationship_started).toDateString().substr(3)}</strong></div>
                            <div className="companyDetails-container-info-extra">
                                <div className="companyDetails-container-info-extra-links">
                                    ...
                                    <div className="companyDetails-container-info-extra-links-info">
                                        ...
                                        <span>Since: {new Date(company.started_at).toDateString().substr(3)}</span>
                                    </div>
                                </div>
                        ...
                        <div className="companyDetails-container-type"><strong>Company Type: </strong>{company.type_company}</div>
                    </div>
                </div>
            </div>
            <Footer/>
